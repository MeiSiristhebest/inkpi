...
- **Lint:** `pnpm lint` → `biome check`. ✅ Clean — zero diagnostics across `packages tests scripts` (255 files); the historical invalid-config debt was cleared as a standalone commit.
